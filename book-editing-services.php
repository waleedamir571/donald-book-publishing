      ...
      <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 col-sm-12">
          <div class="services-inner-banner-style">
            ...
            <p class="main-para">Refine your manuscript for flawless publication with professional editing </p>
            <div class="custom-ul ctaul">
              <ul>
                <li>Recognized Editors Specializing in Fiction & Non-Fiction</li>
                <li>Fast Turnaround with Intricate Eye to Detail
                </li>
                <li>Economic Services with Satisfaction Guaranteed and Unlimited Revisions
                </li>
              </ul>
            </div>
    ...
    <section class="main-our-process-section mb-5" id="our-process-section">
      <div class="container-wrapper">
        ...
        <div class="custom-flex main-our-process-inner-section mt-5 justify-content-around-c">
          ...
          <div class="w-20-c hzoom">
            <div class="my-process-box-inner bg1 bg24 border-radius-20 process-style-content">
              <h3>Step 01<br>
                Manuscript Evaluation</h3>

              <h4> Examine the structure, narrative flow, and key elements to identify areas of improvement.</h4>
            </div>
          </div>
          <div class="w-20-c hzoom">
            <div class="my-process-box-inner bg2 bg-4 border-radius-20 process-style-content">
              ...
              <h4> Refine the language, enhance clarity, and elevate the writing style to engage readers</h4>
            </div>
          </div>
          <div class="w-20-c hzoom">
            <div class="my-process-box-inner bg3 bg-32 border-radius-20 process-style-content">
              ...
              <h4> Eliminate errors, polish grammar, and finalize the formatting for publication-ready perfection.
              </h4>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-6 col-sm-12">
            ...
            <div class="row mb-custom-ul">
              <div class="col-lg-12 col-sm-12">
                <div class="custom-ul ctaul">
                  <ul>
                    <li>Expert Editing to refine structure, style, and flow.
                    </li>
                    <li>Precision-focused revisions to enhance clarity and readability.</li>
          ...
          <div
            ...
            <div class="content-services ">
              <div class="zindex1">
                ...
                <p> Perfect the layout and formatting to ensure a visually appealing, professional presentation.
  ...
  <section class="custom-padding">
    <div class="container-wrapper">
      <div class="custom-flex">
        <div class=" col-md-12 col-sm-12 text-center">
          <div class="myheading-custom heading-custom-withbtn">
            <h2>Ready to Edit Your Book to Perfection?
            </h2>
