...
<div class="body-content">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="services-inner-banner-style">
                        <h1>Designing Websites That Attract and Convert</h1>
                        <p class="main-para">Strategic design and SEO to captivate, engage, and deliver results. </p>
                        <div class="custom-ul ctaul">
                            <ul>
                                <li>Creative designs and SEO to boost online visibility.</li>
                                <li>Fast turnaround for optimized, user-friendly websites.</li>
                                <li>Affordable service – guaranteed excellence – unlimited revisions.</li>
                            </ul>
                        </div>
    ...
    <div class="mb-5 mt-5">
                    ...
                    <div class="w-20-c hzoom">
                        <div class="processboxsection vertical-align-box">
                            <a href="javascript:void();" class="process-box">
                                ...
                                <h6>Strategic Planning & Design</h6>
                            </a>
                            <a href="javascript:void();" class="process-box">
                                <img loading="lazy" alt="Seedspire Publishing" src="assets/images/process-2.webp">
                                <h6>SEO Integration & Optimization</h6>
                            </a>
                            <a href="javascript:void();" class="process-box">
                                <img loading="lazy" alt="Seedspire Publishing" src="assets/images/process-3.webp">
                                <h6>Performance Monitoring & Growth</h6>
                            </a>
                        </div>
                    </div>
                    <div class="w-20-c hzoom">
                        <div class="my-process-box-inner bg1 bg-webdeisgn border-radius-20 process-style-content">
                            <h3>Step 01<br>
                                Strategic Planning & <br /> Design</h3>

                            <h4>Blueprint for online success</h4>
                        </div>
                    </div>
                    <div class="w-20-c hzoom">
                        <div class="my-process-box-inner bg2 bg-webdeisgn2 border-radius-20 process-style-content">
                            ...
                            <h4>Maximize visibility on search</h4>
                        </div>
                    </div>
                    <div class="w-20-c hzoom">
                        <div class="my-process-box-inner bg3 bg-webdeisgn3 border-radius-20 process-style-content">
                            <h3>Step 03<br>
                                Performance Monitoring & Growth</h3>

                            <h4>Analyze, refine, and grow</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="main-our-cta-section   ">
            <div class="container-wrapper">
                <div class="cta-bg border-radius-33 custom-flex cta-ghost bg-webdeisgn ctastyles-new">
                    <div class="col-lg-6">
                        <h4 class="uppercase mb-4">Effective Web Design and SEO for Maximum Impact</h4>
                        <div class="row mb-custom-ul">
                            <div class="col-lg-12 col-sm-12">
                                <div class="custom-ul ctaul">
                                    <ul>
                                        <li>Visually appealing designs that captivate and engage visitors.</li>
                                        <li>SEO strategies to boost traffic and search engine rankings.</li>
                                        <li>User-friendly experiences that drive conversions and build trust.</li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mybox-services-main bg-gray-box mb-custom-20 h-hun-custom position-relative hzoomone">
                        <div class="content-services">
                            ...
                            <p>Tailored websites with responsive, user-friendly designs that capture your brand’s
                                identity.</p>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mybox-services-main bg-gray-box mb-custom-20 h-hun-custom position-relative hzoomone">
                        <div class="content-services">
                            ...
                            <p>Boost your website’s visibility and ranking on search engines with effective SEO
                                strategies.</p>
                            <a href="#." data-bs-toggle="modal" data-bs-target="#contact-popup" class="web-blue-btn">Get
                                a Quote</a>
                            <div class="position-image">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mybox-services-main bg-gray-box mb-custom-20 h-hun-custom position-relative hzoomone">
                        <div class="content-services">
                            ...
                            <p>Seamlessly integrated e-commerce sites to sell products and manage transactions
                                efficiently.</p>
                            <a href="#." data-bs-toggle="modal" data-bs-target="#contact-popup" class="web-blue-btn">Get
                                a Quote</a>
                    ...
                    <div
                        ...
                        <div class="content-services ">
                            <div class="zindex1">
                                ...
                                <p>Ongoing updates and maintenance to ensure your website remains current and
                                    functional.</p>
                    ...
                    <div class="testimonialsbox">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="testimonials-content w-50-custom">
                                ...
                                <p>"Seedspire’s web design and SEO service transformed my website. It’s more
                                    user-friendly, and the traffic has increased significantly. Highly recommend!"</p>
                                <p class="text-dark"><strong>Michael David Clarke</strong></p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="testimonialsbox">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="testimonials-content w-50-custom">
                                <img loading="lazy" alt="Seedspire Publishing" src="assets/images/trust-image.webp">
                                <p>"Thanks to Seedspire, my website looks amazing and ranks higher on search engines.
                                    The team did a fantastic job with both design and SEO. Highly recommend!"</p>
                                <p class="text-dark"><strong> Laura Jane Mitchell</strong></p>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="testimonialsbox">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="testimonials-content w-50-custom">
                                <img loading="lazy" alt="Seedspire Publishing" src="assets/images/trust-image.webp">
                                <p>"I’m so happy with the web design and SEO service from Seedspire. My site now stands
                                    out, and the SEO improvements have made a real difference in visibility."</p>
                                <p class="text-dark"><strong>David Mark Johnson</strong></p>
                            </div>
                        </div>
