...
<div class="body-content">
    ...
    <section class="banner banner-inner custom-padding position-relative-customs">
        <div class="bg-banner-inner-service-img">
            <img loading="lazy" alt="donalds Book Publishing" src="assets/images/web-design/header.png">
        </div>
        <div class="container-wrapper ">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="services-inner-banner-style">
                        <h1>Web Design Services That Captivate
                        </h1>
                        <p class="main-para">At Donald’s Book Publishing, we don’t just build websites, we create
                            digital experiences that attract, engage, and convert. Through strategic design and smart
                            SEO, we help brands stand out online and achieve real results.
                        </p>
        ...
        <section class="main-our-cta-section   ">
            <div class="container-wrapper">
                <div class="cta-bg border-radius-33 custom-flex cta-ghost bg-webdeisgn ctastyles-new">
                    <div class="col-lg-6">
                        <h4 class="uppercase mb-4">What Sets Us Apart?
                        </h4>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="mybox-services-main bg-gray-box mb-custom-20 h-hun-custom position-relative hzoomone">
                        <div class="content-services">
                            ...
                            <div class="position-image">
                                <img loading="lazy" alt="donalds Book Publishing" src="assets/images/web-design/seo.png">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="custom-flex">
                <div class=" col-md-12 col-sm-12 text-center">
                    <div class="myheading-custom heading-custom-withbtn">
                        <h2>Let’s Turn Your Vision Into a High-Impact Website
                        </h2>
