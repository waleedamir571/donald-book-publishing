...
<div class="body-content">
    ...
    <section class="banner banner-inner custom-padding position-relative-customs">
        <div class="bg-banner-inner-service-img">
            <img loading="lazy" alt="donalds Book Publishing" src="assets/images/web-content/header.png">
        </div>
    ...
    <div class="mb-5 mt-5">
        ...
        <section class="main-our-process-section mb-5" id="our-process-section">
            <div class="container-wrapper">
                <h2>Our Content Creation Process
                </h2>
                <div class="custom-flex main-our-process-inner-section mt-5 justify-content-around-c">
                    <div class="w-20-c hzoom">
                        <div class="processboxsection vertical-align-box">
                            <a href="javascript:void();" class="process-box">
                                ...
                                <h6>Research & Strategy Development</h6>
                            </a>
                            <a href="javascript:void();" class="process-box">
                                <img loading="lazy" alt="donalds Book Publishing" src="assets/images/process-2.webp">
                                <h6>Content Creation & Optimization</h6>
                            </a>
                            <a href="javascript:void();" class="process-box">
                                <img loading="lazy" alt="donalds Book Publishing" src="assets/images/process-3.webp">
                                <h6>Editing & Final Integration</h6>
                            </a>
                        </div>
                    </div>
                    <div class="w-20-c hzoom">
                        <div class="my-process-box-inner bg1 bg-contentswriting border-radius-20 process-style-content">
                            <h3>Step 01<br>
                    ...
                    <div class="w-20-c hzoom">
                        <div
                            class="my-process-box-inner bg2 bg-contentswriting2 border-radius-20 process-style-content">
                            <h3>Step 02<br>
                                Content Creation & Optimization</h3>

                            <h4>We write compelling, SEO-optimized content tailored to your message and market.</h4>
                        </div>
                    </div>
                    <div class="w-20-c hzoom">
                        <div
                            class="my-process-box-inner bg3 bg-contentswriting3 border-radius-20 process-style-content">
                            <h3>Step 03<br>
                                Editing & Final <br />Integration</h3>

                            <h4>Our editors fine-tune every word to ensure clarity, flow, and readiness for publishing.
                            </h4>
                        </div>
                    </div>
                </div>
        ...
        <section class="main-our-cta-section   ">
            <div class="container-wrapper">
                <div class="cta-bg border-radius-33 custom-flex cta-ghost bg-blogcontentswritingcta ctastyles-new">
                    <div class="col-lg-6">
                        <h4 class="uppercase mb-4">Impactful Web Content Writing That Drives Action</h4>
                    ...
                    <div
                        ...
                        <div class="content-services ">
                            <div class="zindex1">
                                ...
                                <p>Engage and convert visitors with clear, persuasive landing pages.
                                </p>
                        ...
                        <div class="position-image-custom-ab">
                            <img loading="lazy" alt="donalds Book Publishing" src="assets/images/web-content/landing.png">
                        </div>
                    </div>
                </div>
            ...
            <div class="row flex-align-items-stretch">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div
                        ...
                        <div class="content-services ">
                            <div class="zindex1">
                                <h3>Email <br /> Campaigns</h3>
                                <p>Turn leads into loyal customers with emails that inform, connect, and convert.
                                </p>
                                <a href="#." data-bs-toggle="modal" data-bs-target="#contact-popup"
                                    class="web-blue-btn">Request a Quote
                                </a>
                        ...
                        <div class="position-image-custom-ab">
                            <img loading="lazy" alt="donalds Book Publishing" src="assets/images/web-content/email.png">
                        </div>
                    </div>
                </div>
            </div>
