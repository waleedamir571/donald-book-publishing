...
<style>
    .bg-ctabottom .row {
    background: url(../images/cta-bottom-imagebg.webp) 0 0 / cover no-repeat;
    width: 100%;
    height: 100%;
    padding: 20px 0;
    border-radius: 50px;
            ...
            <div class="cpaddingabout">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                     ...
                     <div class=" btnflex mt-4 text-center">
                        <a href="./" class="web-blue-btn" role="button">Back To Home
                        </a>
