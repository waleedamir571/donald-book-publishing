                ...
                <div class="col-lg-3 col-md-12 col-sm-12">
                    <div class="footer-content">
                        ...
                        <p class="mt-2">Get your book published with the best book publishing services in USA. Trusted
                            by authors for editing, design, and global distribution.</p>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span data-val-controltovalidate="txtcnsite1"
                                        ...
                                        data-val-validationexpression="^[a-zA-Z\s]+$" style="display:none;">
                                        Please
                                        enter correct name
                                    </span>
                                    <span data-val-controltovalidate="txtcnsite1"
                                        ...
                                        data-val-initialvalue="" style="color:Red;display:none;">
                                        Please enter
                                        correct name
                                    </span>
                                </div>
                                ...
                                <div class="col">
                                    <div class="form-group iti-group" aria-hidden="true">
                                        ...
                                        <span data-val-controltovalidate="pnsite1"
                                            ...
                                            data-val-evaluationfunction="RegularExpressionValidatorEvaluateIsValid"
                                            data-val-validationexpression="^[0-9]{10}$" style="display:none;">
                                            Please
...
<script>
    ...
    //     e.preventDefault();
    //     // Perform AJAX or form validation here
    // });
