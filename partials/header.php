            ...
            <div class="container">
                <a class="navbar-brand" href="index.php">
                    <img loading="lazy" alt="Seedspire Publishing" class="d-none-desktop"
                        src="assets/images/mobile-logo.webp" width="137" height="40">
                    <img loading="lazy" alt="Seedspire Publishing" class="d-none-mobile" src="assets/images/logo.webp"
                        width="127" height="37"> </a>
                ...
                <div class="collapse navbar-collapse" id="navbarMain">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="book-writing-services.php">Book
                                Writing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="book-publishing-services.php">Book
                                Publishing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="book-marketing-services.html">Book
                                Marketing</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="audiobook-services.html">Audiobook </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="book-editing-services.html">Book
                                Editing </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="book-printing-services.html">Book
                                Printing </a>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu " aria-labelledby="navbarDarkDropdownMenuLink">
                                <li><a class="dropdown-item" href="book-video-trailer.html">Book Video Trailer</a></li>
                                <li><a class="dropdown-item" href="web-design-and-seo.html">Web design & SEO</a></li>
                                <li><a class="dropdown-item" href="Illustration-services.html">Illustration Services</a>
                                </li>
                                <li><a class="dropdown-item" href="articles-services.html">Articles Services</a></li>
                                <li><a class="dropdown-item" href="book-design-services.html">Book Design Services</a>
                                </li>
                                <li><a class="dropdown-item" href="blog-writing-services.html">Blog Writing Services</a>
                                </li>
                                <li><a class="dropdown-item" href="web-content-writing-service.html">Web Content Writing
                                        Service</a></li>
                            </ul>
                        </li>
